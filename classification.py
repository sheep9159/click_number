...
if __name__ == '__main__':
    ...
    # train_datasets, test_datasets = torch.utils.data.random_split(dataset=datasets, lengths=[int(len(datasets) * 0.7),
    #                                                                                          len(datasets) - int(
    #                                                                                              len(datasets) * 0.7)])
    ...
    #                     test_x_pack = rnn_utils.pack_padded_sequence(test_x, test_x_len, batch_first=True)
